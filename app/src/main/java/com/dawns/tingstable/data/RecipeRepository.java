...
public class RecipeRepository {
    ...
    private static List<Recipe> createBuiltIns() {
        ...
        recipes.add(r("builtin-potato", "酸辣土豆丝", "素菜", "酸辣", "简单", 20, 2,
                ...
                "土豆丝洗净淀粉并大火快炒，成品更爽脆。"));
        recipes.add(r("builtin-green-pepper-pork", "青椒肉丝", "家常菜", "咸鲜", "中等", 25, 2,
                ...
                "肉丝逆纹切、短时间滑炒，口感更嫩。"));
        recipes.add(r("builtin-cola-wings", "可乐鸡翅", "家常菜", "咸甜", "简单", 35, 2,
                ...
                "收汁时勤翻动，避免含糖汤汁粘锅。"));
        recipes.add(r("builtin-mapo-tofu", "麻婆豆腐", "下饭菜", "麻辣", "中等", 25, 2,
        ...
        recipes.add(r("builtin-braised-eggplant", "家常红烧茄子", "下饭菜", "咸鲜", "中等", 30, 3,
                ...
                "茄子提前用盐腌制，可以减少吸油。"));
        recipes.add(r("builtin-steamed-fish", "清蒸鲈鱼", "家常菜", "鲜香", "中等", 25, 3,
        ...
        recipes.add(r("builtin-beef-potato", "土豆炖牛肉", "炖菜", "浓香", "中等", 80, 4,
                ...
                "炖肉时加入热水，肉质不易骤然收紧。"));
        recipes.add(r("builtin-lettuce", "蚝油生菜", "素菜", "咸鲜", "简单", 10, 2,
        ...
        recipes.add(r("builtin-pumpkin-porridge", "南瓜小米粥", "早餐", "清甜", "简单", 40, 3,
